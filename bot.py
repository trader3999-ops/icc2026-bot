...
CAMPS = {
    ...
    "camp2": "Лагерь 2",
    "camp3": "Лагерь 3",
    # "camp4": "Название лагеря 4",
    # "camp5": "Название лагеря 5",
}
...
THANKS = "Спасибо огромное! Ваш ответ получен ✅"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(GREETING["ru"].format(camp=camp_name))
